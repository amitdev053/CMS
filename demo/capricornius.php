					...
					<div class="item-content">
						<div class="media vertical_box big-media">
							<div class="icon-styled color-darkgrey fs-200">
								<i class="color-darkgrey ico ico-icon_capricornius"></i>
							</div>
							<div class="media-body">
								<h6 class="mb-0 fs-40 color-main2">Capricornius</h6>
								<p class="fs-20">Dec 22 - Jan 19</p>
							</div>
						</div>
