		...
		<div class="row">
			<main class="col-lg-8 order-lg-2">
				<div class="img-section">
				    ...
				    <h3>Astro Vastu</h3>
				    <p>vastu concerns it self with space, time and architecture while astrology works with time. making the blend of both is astro - vastu. it is a combination of planets and directions when this combined it becomes astro -vastu. vastu talks about favourable directions & astrology talks about planets, houses, signs & nakshatras</p>
