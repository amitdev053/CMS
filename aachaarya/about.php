...
require '../lib/cms.php';
if($storycolrow > 0){
while($stroyrow = mysqli_fetch_assoc($resultone)){
// print_r($rowone);
...
?>
			...
			<div class="box-vision">
					...
					<?php
					echo '<img src="../uploadimg/'.( $stroyrow['content_image'] ).'"/>';
					?>
                    <h3><?php echo $stroyrow['content_heading']; ?></h3>
                    <p><?php echo $stroyrow['content_discripation']; ?></p>
			</div>
			</div>
			<?php
}
