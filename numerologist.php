...
<h1 class="sectionheading">Create Numerologist Content</h1>
<form id="addcontentform" method="post" action="./php/uploadnumerologistcontent.php"  enctype="multipart/form-data">

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Heading</label>
    <input type="text" class="form-control" id="aboutheading"name="numerologistheading" required>
  </div>

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Discription</label> 
    <input type="text" id="aboutdiscripation" name="numerologistdiscripation" class="form-control"  >
  </div>
  ...
  <input type="file" id="astrologyimage" accept="image/*" name="numerologistimage"  required>
...
let images = document.getElementById('numerologistimage')
 document.getElementById('numerologistimage').onchange = evt => {
 ...
 let  filename = images.files[0].name
  if (file) {
    ...
    document.getElementById('numerologistimage').style.display= "none"
