...
<?php
echo '<input id="setkeyinput"name="setkeyname"></input>';
?>

<?php
require '../lib/cms.php';

echo '<script>let pagename ="index_page";let pageheading= "Sun Sigin";</script>';

 $index_content = get_cms_content("index_page", "sun sigin");
?>
...
<?php
	echo '<img src="../uploadimg/'.( $index_content['content_image'] ).'" class="horoscope-image">';
?>
			</div>
...
<section id="about" class="ds c-gutter-50">
	<div class="container">
<?php
...
<?php
	echo '<img src="../uploadimg/'.( $about_content['content_image'] ).'" >';
?>
			    </div>
			</div>
			<div class="col-lg-6 text-center text-md-left">
				...
				<a href="about.php" class="btn btn-outline-maincolor btn-medium">Read More</a>
			</div>
		</div>
	</div>
</section>
					...
					<div class="product-inner">
						...
						<div class="product-wrap">
							<h2 class="woocommerce-loop-product__title">
								<a href="astrologer.php">Astrologer </a>
							</h2>
		    ...
		    <div class="col-md-3">
		        <div class="product">
					<div class="product-inner">
						...
						<div class="product-wrap">
							<h2 class="woocommerce-loop-product__title">
								<a href="numerologist.php">Numerologist </a>
							</h2>
							<div class="price-wrap">
								<a href="tel:+91-9810288915" class="button product_type_simple add_to_cart_button"><i class="fa fa-phone"></i> Call Now</a>
							</div>
		    ...
		    <div class="col-md-3">
		        <div class="product">
					<div class="product-inner">
						...
						<div class="product-wrap">
							<h2 class="woocommerce-loop-product__title">
								<a href="astrovastu.php">Astro Vastu </a>
							</h2>
							<div class="price-wrap">
								<a href="tel:+91-9810288915" class="button product_type_simple add_to_cart_button"><i class="fa fa-phone"></i> Call Now</a>
							</div>
...
<script>
	...
	fetch('../php/getcontents.php').then(function(response){
		...
		console.log(result)
		for(let r in result){
			let section = result[r].section_id
			if(section == pagename){
				
			console.log("We have Taken", result[r].content_heading)
			let indexheading =document.getElementById("indexheading").innerText


		
			if(indexheading.lastIndexOf("18")){

				console.log(pageheading)
				console.log(result[r].content_heading)
				console.log("Last index is 18")

				if(result[r].content_heading == pageheading){
					setkey = result[r].content_heading
					console.log("setkey in js", setkey)
					document.getElementById('setkeyinput').value = setkey

					
				}else{
					console.log("pageheading and contentkey is equal ")
					setkey = result[r].content_heading
					console.log("setkey in js", setkey)
					document.getElementById('setkeyinput').value = setkey
				}
...
<?php
$key = '<script>document.write(setkey)</script>';
?>